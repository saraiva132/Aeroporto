 ...
 * Instanciação e inicialização do monitor <b>ZonaDesembarque</b>
     * @param log
 */
public ZonaDesembarque(Logging log)
{
    this.log = log;
   nPass = passMax;
   canGo = false;
...
public synchronized void  takeARest()
{
     ...
     */
@Override
public synchronized destination whatShouldIDo(boolean dest,int nMalas,int passID)
{
    log.reportState(passID,AuxInfo.passState.AT_THE_DISEMBARKING_ZONE);
